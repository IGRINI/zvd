...
namespace Game.Utils
{
    public static class DebugExtensions
    {
        ...
        {
            for (var angle = 0; angle < 360; angle = angle + quality)
            {
        ...
        public static void DrawWireSphere(Vector3 center, float radius, Color color, float duration = 0,
            int quality = 3)
        {
            ...
            for (var i = 0; i < segments; i++)
            {
                ...
                var axis = Quaternion.AngleAxis(90F, Vector3.up) * first;
