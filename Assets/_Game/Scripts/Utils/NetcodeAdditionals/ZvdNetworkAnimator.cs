...
namespace Game.Utils.NetcodeAdditionals
{
    internal class CustomNetworkAnimatorStateChangeHandler : INetworkUpdateSystem
    {
        private ZvdNetworkAnimator m_NetworkAnimator;
                ...
                case NetworkUpdateStage.PreUpdate:
                    {
                        ...
                        if ((m_NetworkAnimator.IsOwner && m_NetworkAnimator.SyncEnabled) || m_IsServer)
                        {
        ...
        private struct AnimationUpdate
        {
            ...
            public ZvdNetworkAnimator.AnimationMessage AnimationMessage;
        }
        ...
        /// </summary>
        internal void SendAnimationUpdate(ZvdNetworkAnimator.AnimationMessage animationMessage, ClientRpcParams clientRpcParams = default)
        {
        ...
        {
            public ClientRpcParams ClientRpcParams;
            public ZvdNetworkAnimator.ParametersUpdateMessage ParametersUpdateMessage;
        }
        ...
        /// </summary>
        internal void SendParameterUpdate(ZvdNetworkAnimator.ParametersUpdateMessage parametersUpdateMessage, ClientRpcParams clientRpcParams = default)
        {
        ...
        private List<ZvdNetworkAnimator.ParametersUpdateMessage> m_ProcessParameterUpdates = new List<ZvdNetworkAnimator.ParametersUpdateMessage>();
        internal void ProcessParameterUpdate(ZvdNetworkAnimator.ParametersUpdateMessage parametersUpdateMessage)
        {
        ...
        private struct TriggerUpdate
        {
            ...
            public ClientRpcParams ClientRpcParams;
            public ZvdNetworkAnimator.AnimationTriggerMessage AnimationTriggerMessage;
        }
        ...
        /// </summary>
        internal void QueueTriggerUpdateToClient(ZvdNetworkAnimator.AnimationTriggerMessage animationTriggerMessage, ClientRpcParams clientRpcParams = default)
        {
        ...
        internal void QueueTriggerUpdateToServer(ZvdNetworkAnimator.AnimationTriggerMessage animationTriggerMessage)
        {
        ...
        internal CustomNetworkAnimatorStateChangeHandler(ZvdNetworkAnimator networkAnimator)
        {
    ...
    /// <summary>
    /// CustomNetworkAnimator enables remote synchronization of <see cref="UnityEngine.Animator"/> state for on network objects.
    /// </summary>
    [AddComponentMenu("Netcode/Zvd Network Animator")]
    [RequireComponent(typeof(Animator))]
    public class ZvdNetworkAnimator : NetworkBehaviour, ISerializationCallbackReceiver
    {
        [Serializable]
        ...
        [SerializeField] private bool m_SyncEnabled = true;
        [SerializeField] private List<ulong> m_ClientSyncList = new List<ulong>();
        ...
        public bool SyncEnabled
        {
            ...
            set { m_SyncEnabled = value; }
        }

        public void AddClientToSyncList(ulong clientId)
        {
            if (!m_ClientSyncList.Contains(clientId))
            {
                m_ClientSyncList.Add(clientId);
            }
        }

        public void RemoveClientFromSyncList(ulong clientId)
        {
            if (m_ClientSyncList.Contains(clientId))
            {
                m_ClientSyncList.Remove(clientId);
            }
        }
        ...
        private CustomNetworkAnimatorStateChangeHandler m_NetworkAnimatorStateChangeHandler;
        ...
        public override void OnNetworkSpawn()
        {
            ...
            if (m_Animator == null)
            {
                NetworkLog.LogWarningServer($"[{gameObject.name}][{nameof(ZvdNetworkAnimator)}] {nameof(Animator)} is not assigned! Animation synchronization will not work for this instance!");
            }
            ...
            m_NetworkAnimatorStateChangeHandler = new CustomNetworkAnimatorStateChangeHandler(this);
        }
        ...
        internal void CheckForAnimatorChanges()
        {
            ...
            if (m_AnimationMessage.IsDirtyCount > 0)
            {
                ...
                else
                {
                    ...
                    foreach (var clientId in m_ClientSyncList)
                    {
